...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LoadingDialog_t, stringdata) + ofs \
...
const QMetaObject LoadingDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_LoadingDialog.data,
      qt_meta_data_LoadingDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LoadingDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LoadingDialog.stringdata))
